...
class YOLO(Model):
    ...
    Attributes:
        ...
        task: The task type (detect, segment, classify, pose, obb, roof).
    ...
    def task_map(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "roof":{
                "model": RoofModel,
                "trainer": yolo.roof.RoofTrainer,
                "validator": yolo.roof.RoofValidator,
                "predictor": yolo.roof.RoofPredictor,
            }
        }
